...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid max-h-[calc(100dvh-2rem)] w-[min(92vw,640px)] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto rounded-[24px] border border-white/70 bg-white/95 p-6 shadow-[0_24px_80px_rgba(16,34,22,0.18)] duration-200 sm:rounded-[32px] sm:p-8",
        className,
      )}
      {...props}
    >
